var primaryColor = "#f7b869",
    secondaryColor = "#547eac",
    tertiaryColor = "#6d63a1",
    quaternaryColor = "#dbd6d6",
    quinaryColor = "#ffebd1",
    //Fim das declarações de cores
    headerDiff = 103,
    headerDiffAfter = 102,
    _w = window,
    _d = document,
    ...
    stepFive = _d.querySelector(".pp-quinary-bg"),
    // stepSix = _d.querySelector(".pp-quinary-bg"),
    // fim da modificação
    ...
    stepFiveBtn = _d.getElementById("step-five--btn"),
    // stepSixBtn = _d.getElementById("step-six--btn"),
    // fim da modificação
...
_w.addEventListener("scroll", function() {
    ...
    //  console.log(a > stepThrscrollToee.offsetTop - headerDiff && a < stepFour.offsetTop - headerDiffAfter);
    0 <= a && a < stepOne.offsetTop - headerDiffAfter ? (navbar.style.backgroundColor = "", navLogo.classList.remove("show-logo"), navbarList.forEach(function(a, b) {
        ...
        (navLogo.classList.remove("show-logo"), navbar.style.backgroundColor = "") : (navLogo.classList.add("show-logo"), navbar.style.backgroundColor = primaryColor)) : a > stepOne.offsetTop - headerDiff && a < stepTwo.offsetTop - headerDiffAfter ? (navbar.style.backgroundColor = primaryColor, navbarList.forEach(function(a, b) {
        a.classList.remove("active-link");
        a.style.color = "#FFF"
        ...
        secondaryColor, navbarList.forEach(function(a, b) {
            a.classList.remove("active-link")
        ...
        tertiaryColor, navbarList.forEach(function(a, b) {
            a.classList.remove("active-link")
    }),
    stepThreeBtn.classList.add("active-link")) : a > stepFour.offsetTop - headerDiff && a < stepFive.offsetTop - headerDiffAfter ? (navbar.style.backgroundColor =
<<<<<<< HEAD
        quaternaryColor, navbarList.forEach(function(a, b) {
        a.classList.remove("active-link")
}),
    stepFourBtn.classList.add("active-link")) : a > stepFive.offsetTop - headerDiff && (navbar.style.backgroundColor = quinaryColor, navbarList.forEach(function(a, b) {
=======
        "#BCB4D1", navbarList.forEach(function(a, b) {
        a.classList.remove("active-link")
}),
    stepFourBtn.classList.add("active-link")) : a > stepFive.offsetTop - headerDiff && (navbar.style.backgroundColor = "#BCB4D1", navbarList.forEach(function(a, b) {
>>>>>>> Pequenos ajustes no background e cores
    a.classList.remove("active-link")       
}), 
    stepFiveBtn.classList.add("active-link"))
});
// fim da modificação
_d.body.addEventListener("click", function(a) {
    ...
    a.target.matches("#step-four--btn") ? scrollTo("#step-four", 95) : 
    a.target.matches("#step-five--btn, .pp-parallax__scroll-btn") ? scrollTo("#step-five", 95): 
